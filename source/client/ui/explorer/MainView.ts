...
export default class MainView extends CustomElement
{
    ...
    protected connected()
    {
        ...
        if (!this._stateSubscribed) {
            ...
            // baseline against the current state (the first load state is set
            // during construction, before this view subscribes); consumers that
            // need the current value on attach can read getState()
