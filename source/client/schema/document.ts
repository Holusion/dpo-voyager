...
/**
 * Lifecycle phases of the viewer with respect to its document.
 * See docs/architecture-lifecycle.md.
 *
 * - Loading: a document/model load is in flight.
 * - Ready: the document's scene graph is built and the viewer is interactable.
 *   An empty or default scene is Ready. Derivatives may still be streaming.
